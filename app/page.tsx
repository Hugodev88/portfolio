          ...
          <div className="xl:col-span-2 xl:col-start-1 xl:row-start-1 xl:mx-auto xl:grid xl:w-full xl:max-w-7xl xl:grid-cols-[0.9fr_1fr] xl:gap-x-2 xl:px-0">
            <div className="xl:w-[700px] xl:pr-0">
              ...
              <p className="mt-6 line-clamp-9 text-gray-700 xl:text-lg xl:leading-relaxed">
                I am a Computer Science graduate from Centro Universitário Una with a strong interest in software development, particularly backend engineering. I have experience building web applications using technologies such as Node.js, TypeScript, MongoDB, and REST APIs.
Throughout my academic journey and personal projects, I developed full-stack applications, working with authentication, database design, API development, responsive interfaces, and software architecture. These experiences strengthened my problem-solving skills and understanding of modern development practices.
I am currently seeking junior software developer or freelance opportunities where I can apply my technical skills, continue learning, and contribute to projects that deliver real value.
              </p>
              <div className="pt-8">
                <a
                  href="/#contact"
